/**
 * Simple SHA256 hash implementation for firmware verification.
 * In production, use crypto.createHash('sha256') from Node.js or
 * a React Native crypto library.
 */
